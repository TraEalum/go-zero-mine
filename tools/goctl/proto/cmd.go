...
func init() {
	...
	Cmd.Flags().StringVar(&stringServiceName, "service_name", "", "the protobuf service name , defaults to the database schema.")
	Cmd.Flags().StringVar(&stringPackage, "package", "", "the protocol buffer package. defaults to the database schema.")
	Cmd.Flags().StringVar(&stringGoPackage, "go_package", "", "the protocol buffer go_package. defaults to the database schema.")
